...
def kirim_email(pengirim, penerima, subject, html_content):
    ...
    server.starttls()
    server.login(pengirim, 'fhks pvxj fyfz dvnj')  # Pastikan ini adalah sandi atau token aman
...
pengirim = 'nadia.ids.saputri@gmail.com'
penerima = 'sadiyahrpl@gmail.com'
subject = 'Nadia saputri salmandika/24'
