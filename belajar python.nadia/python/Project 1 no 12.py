...
namafile = r'C:\Users\LENOVO X390\Documents\nadiaaList\belajar python.nadia\python\07.Project 1 no 12.py'
...
def update_karyawan(id=None, nama=None, jabatan=None, gaji=None):
    rows = []
    updated = False
    with open(namafile, mode='r', newline='') as file:
        reader = csv.reader(file)
